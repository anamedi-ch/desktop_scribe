...
pub fn get_issue_url(logs: String) -> String {
    ...
    format!("https://github.com/anamedi-ch/desktop_scribe/issues/new?assignees=octocat&labels=bug&projects=&template=bug_report.yaml&title=App+reports+bug&logs={}", urlencoding::encode(&format!("{}\n\n{}", extra_info, &logs)))
}
